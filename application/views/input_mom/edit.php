        ...
        <div class="container-fluid">
            ...
            <h1 class="h3 mb-4 text-gray-800"> <i class="far fa-newspaper"></i>  <?= $title; ?></h1>
                 ...
                 <div class="card shadow mb-4">
                            ...
                            <form action="<?= base_url('MoM/updatedata/'.$data->meet_id) ?>" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <div class="col-md-14" style="width:15%">
                                        ...
                                        <select id="jobsite" name="jobsite" class="custom-select">
                                            ...
                                            <?php foreach ($site as $rowSite) { ?>
                                                <option <?=$rowSite->siteID == $data->site ? "selected" : null?> value="<?= $rowSite->siteID ?>"><?= $rowSite->siteID?></option>
                                            <?php } ?>
                                        </select>    
                                    </div>
                                ...
                                <div class="form-group"> 
                                    <div class="col-md-14" style="width:30%">                   
                                        ...
                                        <select id="nama_meet" name='nama_meet' class="custom-select" value="<?= $data->meeting_name; ?>">
                                            <option value=""></option>
                                            <?php foreach ($type as $rowMeet) { ?>
                                                <option <?=$rowMeet->meet_type_id == $data->meeting_name ? "selected" : null?> value="<?= $rowMeet->meet_type_id ?>"><?= $rowMeet->meet_type_id?></option>
                                            <?php } ?>
                                        </select>  
                                    </div>  
                                ...
                                <div class="form-group" style="width:50%;display:<?php echo ($data->is_online == '1' ? 'block' : 'none') ?>" id="typeLink">
                                    <input type="text" id="linkzoom" name="linkzoom" class="form-control" style="resize: none" value="<?= $data->link; ?>"></input>      
                                ...
                                <div class="form-group" id="meetvenue" style="display:<?php echo ($data->is_online == '0' ? 'block' : 'none') ?>">
                                    <div class="col-md-14" style="width:50%">     
                                        ...
                                        <select id="tempat" name="tempat" class="custom-select" value="<?= $data->venue; ?>">
                                            <option value="0">-- Pilih Ruangan --</option>
                                            <?php foreach ($venue as $rowVenue) { ?>
                                                <option <?=$rowVenue->venue_name == $data->venue ? "selected" : null?> value="<?= $rowVenue->venue_name ?>"><?= $rowVenue->venue_name?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                ...
                                <div class="form-group">
                                    <label for="date" class="font-weight-bold">Tanggal & Waktu/Date & Time:</label>
                                        <div class="input-group-prepend">
                                            <input type="date" id="date" name="tanggal" class="form-control" style="width:20%" value="<?= $data->meeting_date; ?>">
                                            <?= form_error('date', '<small class="text-danger pl-3">', '</small>'); ?>
                                            <input type="time" id="start_time" name="start" class="form-control" style="width:15%" value="<?= $data->meeting_start; ?>">
                                            <?= form_error('start_time', '<small class="text-danger pl-3">', '</small>'); ?>
                                            <input type="time" id="end_time" name="end" class="form-control" style="width:15%" value="<?= $data->meeting_end; ?>">
                                ...
                                <div class="form-group">
                                    <div class="col-md-14" style="width:45%">                    
                                        ...
                                        <select id="leader" class="custom-select" name='leader' value="<?= $data->chair; ?>"> 
                                            <option value="">-- Pilih Pemimpin --</option>
                                            <?php foreach ($chair as $rowChair) { ?>
                                                <option <?=$rowChair->EmployeeName == $data->chair ? "selected" : null?> value="<?= $rowChair->EmployeeName ?>"><?= $rowChair->EmployeeName?></option>
                                            <?php } ?>            
                                        </select>
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-14" style="width:45%">                    
                                        ...
                                        <select id="notulen" name='notulen' class="custom-select">
                                            ...
                                            <?php foreach ($notulen as $rowNotulen) { ?>
                                                <option <?=$rowNotulen->EmployeeName == $data->notulen ? "selected" : null?> value="<?= $rowNotulen->EmployeeName ?>"><?= $rowNotulen->EmployeeName?></option>
                                            <?php } ?>
                                        </select>
                                    </div>  
                                ...
                                <div class="form-group">                    
                                    ...
                                    <textarea id="agenda" name="agenda" class="form-control" style="resize: none" rows="5"><?= $data->agenda; ?></textarea>      
                                    <?= form_error('agenda', '<small class="text-danger pl-3">', '</small>'); ?>
                                    
                                </div>
                                <div class="form-group">                    
                                    <label for="notes" class="font-weight-bold">Notes:</label>
                                    <textarea id="notes" name="notes" class="form-control" style="resize: none" rows="5"><?= $data->notes; ?></textarea>      
                                            ...
                                            <div class="col-md-14" style="width:45%">                       
                                                <select id="entrant" name='entrant' class="custom-select">
                                                    <option value="0">-- Pilih Karyawan --</option>
                                                        <?php foreach ($notulen as $rowNotulen) { ?>
                                                    <option value="<?= $rowNotulen->EmployeeID ?>"><?= $rowNotulen->EmployeeName?></option>
                                            <?php } ?>        
                                                </select>
                                            </div>
                                        ...
                                        foreach($entlist as $list) :?>
                                            <tr>
                                                ...
                                                <td class="align-middle" style="width:5%">
                                                    <a href="<?= base_url('MoM/hapusEntrant/'.$list['entrant_id']);?>" type="submit" name="delEnt" class="btn btn-info btn-icon-split mb-3 mt-1">
                    ...
                    <button type="submit" class="btn btn-success" name="update"><i class="fas fa-check-circle"></i>Update</button>

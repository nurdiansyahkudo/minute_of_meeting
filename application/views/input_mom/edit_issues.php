        ...
        <div class="container-fluid">
            ...
            <h1 class="h3 mb-4 text-gray-800"> <i class="far fa-newspaper"></i><?= $title; ?></h1>
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form action="<?= base_url('MoM/updateIssue/'.$issues->meet_ID) ?>" method="post" enctype="multipart/form-data">
                            <div class="form-group"> <!-- Issues -->
                                <div class="col-md-14" style="width:50%">
                                    <label for="issues" class="font-weight-bold">Issues:</label>
                                    <input type="text" name="issues" class="form-control" value="<?= $issues->issues; ?>" disabled></input>
                                </div>
                            ...
                            <div class="form-group"> <!-- Action -->
                                <div class="col-md-14" style="width:50%">
                                    ...
                                    <input type="text" id="action" name="action" class="form-control" style="resize: none" value="<?= $issues->action; ?>" disabled></input>
                                </div>
                            ...
                            <div class="form-group"> <!-- Output -->
                                <div class="col-md-14" style="width:50%">
                                    ...
                                    <input type="text" id="output" name="output" class="form-control" style="resize: none" value="<?= $issues->output; ?>" disabled></input>
                                </div>
                                ...
                                <div class="col-md-14" style="width:45%">                    
                                    ...
                                    <select id="pic" class="custom-select" name='pic'>
                                        ...
                                        <?php foreach ($pic as $rowPIC) { ?>
                                                <option <?=$issues->pic == $rowPIC->EmployeeID ? "selected" : null?> value="<?=$rowPIC->EmployeeID?>"><?= $rowPIC->EmployeeName?></option>
                                            <?php } ?>           
                                    </select>
                                </div>
                            ...
                            <div class="form-group"> <!-- Due date -->
                                <label for="date" class="font-weight-bold">Due Date:</label>
                                    <input type="date" id="duedate" name="duedate" class="form-control" style="width:20%" value="<?= $issues->due_date; ?>" disabled>
                                    <?= form_error('duedate', '<small class="text-danger pl-3">', '</small>'); ?>            
                            </div>
                            <div class="form-group"> <!-- Status (fungsi edit dan update belum berfungsi) -->
                                <div class="col-md-14" style="width:20%">                    
                                    <label for="" class="font-weight-bold">Status:</label>
                                    <select id="status" class="custom-select" name='status'>
                                        <option value="">-- Status --</option>
                                        <option value="open" <?=$issues->status == "open" ? "selected" : null?>> Open </option>
                                        <option value="closed" <?=$issues->status == "closed" ? "selected" : null?>> Closed </option>        
                                    </select>
                                </div>
                            ...
                            <div class="form-group"> <!-- Action date -->
                                <label for="date" class="font-weight-bold">Action Date:</label>
                                    <input type="date" id="actdate" name="actdate" class="form-control" style="width:20%" value="">
                                    <?= form_error('actdate', '<small class="text-danger pl-3">', '</small>'); ?>            
                            </div>
                            


                <button type="submit" class="btn btn-success" name="updateIssue"><i class="fas fa-check-circle"></i>Update</button>
